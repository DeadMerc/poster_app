define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "event",
            "description": "<p>ID ивента, если отправить этот параметр, то картинка автоматически прикрепится к ивенту</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "name": "uploadFiles",
    "group": "Upload",
    "description": "<p>Название параметра не имеет значение, главное чтобы это были файлы.</p>",
    "filename": "app/Http/Controllers/Controller.php",
    "groupTitle": "Upload",
    "sampleRequest": [
      {
        "url": "/api/images/uploadFiles"
      }
    ]
  },
  {
