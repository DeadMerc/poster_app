...
!function () {
                    ...
                    post: function (a, b, c, d) {
                        ...
                        function f() {
                            if ("left" === a.side || "right" === a.side) {
                                for (var b = h.renderContainers[a.side].visibleColumnCache, c = 0,
                                         d = 0; d < b.length; d++) {
                                    var e = b[d];
    ...
    angular.module("ui.grid").factory("GridRenderContainer", ["gridUtil", "uiGridConstants", function (a, b) {
        ...
        return c.prototype.reset = function () {
            ...
            for (var a = this, b = 0, c = 0, d = a.getViewportHeight(),
                     e = a.visibleRowCache.length - 1; d > c && e >= 0; e--)c += a.visibleRowCache[e].height, b++;
            return b
    ...
    a.service("rowSorter", ["$parse", "uiGridConstants", function (a, b) {
        ...
        return d.guessSortFn = function (a) {
            ...
            var e;
            return d.colSortFnCache[b.colDef.name] ? e = d.colSortFnCache[b.colDef.name] : void 0 !== b.sortingAlgorithm ? (e = b.sortingAlgorithm, d.colSortFnCache[b.colDef.name] = b.sortingAlgorithm) : b.sortCellFiltered && b.cellFilter ? (e = d.sortAlpha,
                d.colSortFnCache[b.colDef.name] = e) : (e = d.guessSortFn(b.colDef.type), e ? d.colSortFnCache[b.colDef.name] = e : e = d.sortAlpha), e
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("hy", {
                ...
                aggregation: {
                    count: "ընդամենը տող՝ ",
                    sum: "ընդամենը՝ ", avg: "միջին՝ ", min: "մին՝ ", max: "մաքս՝ "
                },
                    ...
                    pre: function (a, f, g, h) {
                        ...
                        function f() {
                            ...
                            b.prepend(e), a.$on(c.CELL_NAV_EVENT, function (a, b, c, d) {
                                ...
                                if (!d || "focus" !== d.type) {
                                    for (var g = [], i = h.api.cellNav.getCurrentSelection(),
                                             j = 0; j < i.length; j++)g.push(h.getCellDisplayValue(i[j].row, i[j].col));
                                    var k = g.toString();
                                    f(k)
                                }
                            })
            ...
            initializeGrid: function (a, b) {
                ...
                for (var l = function (a) {
                        return angular.isObject(a) ? JSON.stringify(a) : a
                         ...
                         n = 0; g > n; n++)m && m[l(d[n].currentValue)] && (m = m[l(d[n].currentValue)].children);
                var o;
                        ...
                        if (j.options.enableColumnResizing) {
                            ...
                            var m = function () {
                                for (var b = d[0].getElementsByClassName("ui-grid-column-resizer"),
                                         f = 0; f < b.length; f++)angular.element(b[f]).remove();
