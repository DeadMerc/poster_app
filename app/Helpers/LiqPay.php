...
class LiqPay
{
     ...
     */
    public function __construct($public_key = 'i86486134497', $private_key = '0foihDsSyU2vjha4jAq5YNIwNoudMpMsy7JMqXKT')
    {
        if (empty($public_key)) {
        ...
        $this->_public_key = 'i86486134497';
        $this->_private_key = '0foihDsSyU2vjha4jAq5YNIwNoudMpMsy7JMqXKT';
    }
